...
abstract class ControllerCore
{
    ...
    public function __construct()
    {
        ...
        $s3Client = new S3Client([
            ...
            'region'      => 'us-west-2',
            'credentials' => [
                'key'    => 'AKIAINRXJKHNDMPIG56Q',
                'secret' => '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',
            ],
        ]);
        $s3Client->registerStreamWrapper();
//        $s3Client->uploadDirectory(__DIR__ . '/../../img', 'elasticbeanstalk-us-west-2-404473385432');
//        $data = file_get_contents('s3://elasticbeanstalk-us-west-2-404473385432/test');
//        d($data);
