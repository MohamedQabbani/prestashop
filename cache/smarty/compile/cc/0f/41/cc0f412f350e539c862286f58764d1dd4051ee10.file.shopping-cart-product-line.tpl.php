<?php /* Smarty version Smarty-3.1.19, created on 2017-04-16 09:17:32
         compiled from "/var/www/public/themes/default-bootstrap/shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:137359882758f336ac4c3bf9-40849272%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cc0f412f350e539c862286f58764d1dd4051ee10' => 
    array (
      0 => '/var/www/public/themes/default-bootstrap/shopping-cart-product-line.tpl',
      1 => 1489499358,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '137359882758f336ac4c3bf9-40849272',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f336ac7ff017_84766744',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f336ac7ff017_84766744')) {function content_58f336ac7ff017_84766744($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/public/tools/smarty/plugins/modifier.replace.php';
...
_<?php if ($_smarty_tpl->tpl_vars['quantityDisplayed']->value>0) {?>nocustom<?php } else { ?>0<?php }?>_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
<?php $_tmp33=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product_attribute']);?>
<?php $_tmp34=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
<?php $_tmp35=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp33."&amp;ipa=".$_tmp34."&amp;id_address_delivery=".$_tmp35."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
