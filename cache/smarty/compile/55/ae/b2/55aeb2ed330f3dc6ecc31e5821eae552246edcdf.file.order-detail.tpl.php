<?php /* Smarty version Smarty-3.1.19, created on 2017-04-16 09:17:30
         compiled from "/var/www/public/themes/default-bootstrap/order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:43895005858f336aa760ff3-06862629%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '55aeb2ed330f3dc6ecc31e5821eae552246edcdf' => 
    array (
      0 => '/var/www/public/themes/default-bootstrap/order-detail.tpl',
      1 => 1489499358,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '43895005858f336aa760ff3-06862629',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f336ab01a738_87543882',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f336ab01a738_87543882')) {function content_58f336ab01a738_87543882($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/public/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_counter')) include '/var/www/public/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/public/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp21=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp20."-".$_tmp21."&id_order=".((string)$_smarty_tpl->tpl_vars['order']->value->id)."&secure_key=".((string)$_smarty_tpl->tpl_vars['order']->value->secure_key)), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Download this product'),$_smarty_tpl);?>
"> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_name'], ENT_QUOTES, 'UTF-8', true);?>
 	</a>
									<?php } else { ?>
...
<?php $_tmp23=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp22."-".$_tmp23), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Download this product'),$_smarty_tpl);?>
"> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_name'], ENT_QUOTES, 'UTF-8', true);?>
 	</a>
									<?php }?>
