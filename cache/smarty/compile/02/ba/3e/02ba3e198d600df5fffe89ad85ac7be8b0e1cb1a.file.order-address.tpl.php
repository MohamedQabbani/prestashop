<?php /* Smarty version Smarty-3.1.19, created on 2017-04-16 09:17:32
         compiled from "/var/www/public/themes/default-bootstrap/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:116667869358f336ac83d5c4-13928664%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '02ba3e198d600df5fffe89ad85ac7be8b0e1cb1a' => 
    array (
      0 => '/var/www/public/themes/default-bootstrap/order-address.tpl',
      1 => 1489499358,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '116667869358f336ac83d5c4-13928664',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f336ac9a4ae7_69637959',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f336ac9a4ae7_69637959')) {function content_58f336ac9a4ae7_69637959($_smarty_tpl) {?>
...
" class="button button-small btn btn-default">
	...
	<p class="address_add submit">
		<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp37=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp37), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="button button-small btn btn-default">
...
" />
				<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "back=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp38=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink($_smarty_tpl->tpl_vars['back_order_page']->value,true,null,$_tmp38), ENT_QUOTES, 'UTF-8', true);?>
